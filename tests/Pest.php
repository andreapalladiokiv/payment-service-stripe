 ...
 *
 * Deliberately NOT `Domain\Customer\ValueObject\CustomerId`: Stripe depends on `Common` and
 ...
 */
function stripeSuiteCustomerId(string $id = '01920000-0000-7000-8000-00000000cafe'): CustomerIdentifier
{
    /**
